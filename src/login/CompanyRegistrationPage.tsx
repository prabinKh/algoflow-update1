            ...
            <form className="space-y-6 relative" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1.5 block">Business Type</label>
                    <div className="relative">
                      <select
                        name="business_type"
                        required
                      ...
                      >
                        ...
                        <option value="Glass & Lens (Optical/Eyewear)">👓 Glass & Lens (Optical/Eyewear)</option>
                        <option value="Cafe (Coffee Shop / F&B E-commerce)">☕ Cafe (Coffee Shop / F&B E-commerce)</option>
                        <option value="Hotels (Hospitality / Booking Platform)">🏨 Hotels (Hospitality / Booking Platform)</option>
                        <option value="Liquor Shop (Alcoholic Beverages)">🍷 Liquor Shop (Alcoholic Beverages)</option>
                      </select>
                    </div>
                  </div>
