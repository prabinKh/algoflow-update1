          ...
          >
            ...
            <div className="bg-card border border-border rounded-3xl p-6 shadow-sm">
                ...
                {order.items.map((item, i) => (
                  <div key={i} className="flex gap-4 p-3 bg-accent/20 rounded-2xl border border-border">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Qty: {item.quantity} × Rs. {(item.price || 0).toLocaleString()}</p>
              ...
              <div className="mt-6 pt-6 border-t border-border flex justify-between items-center">
                ...
                <span className="text-xl font-display font-bold text-primary">Rs. {(order.totalAmount || 0).toLocaleString()}</span>
              </div>
            </div>
