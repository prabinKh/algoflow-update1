                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2 text-[10px] text-muted-foreground mt-0.5">
                                    <Calendar size={12} />
                                    {order.createdAt 
                                      ? format(typeof order.createdAt.toDate === 'function' ? order.createdAt.toDate() : new Date(order.createdAt as string | number | Date), "MMM dd, yyyy • hh:mm a") 
                                      : "Recently"}
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2 text-[10px] text-muted-foreground mt-0.5">
                                    <Calendar size={12} />
                                    {ticket.createdAt 
                                      ? format(typeof ticket.createdAt.toDate === 'function' ? ticket.createdAt.toDate() : new Date(ticket.createdAt as string | number | Date), "MMM dd, yyyy • hh:mm a") 
                                      : "Recently"}
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-[10px] text-muted-foreground">
                                  {search.timestamp 
                                    ? format(typeof search.timestamp.toDate === 'function' ? search.timestamp.toDate() : new Date(search.timestamp as string | number | Date), "MMM dd, yyyy • hh:mm a") 
                                    : "Recently"}
                                </p>
                              </div>
                            </div>
