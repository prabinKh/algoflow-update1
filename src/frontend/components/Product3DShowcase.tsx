...
export const Product3DShowcase: React.FC<Product3DShowcaseProps> = ({ mainImage, additionalImages = [], model3D }) => {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto py-12 px-4">
      ...
      >
        <div className="absolute inset-0 bg-[#1a1a1a] rounded-[2rem] border-[12px] border-[#333] shadow-2xl overflow-hidden">
        ...
        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-[110%] h-6 bg-gradient-to-b from-[#444] to-[#222] rounded-b-xl shadow-2xl" />
        <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[40%] h-2 bg-[#111] rounded-full opacity-50 blur-md" />
